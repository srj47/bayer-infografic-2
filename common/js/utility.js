var utility = {
  ...
  defination: function () {
    ...
    this.pageClick.off("click").on("click", function () {
      utility.pageClickTrigger($(this), "navBtn");
    });
  ...
  menuAnchorTrigger: function () {
    ...
    $(".fullpage-wrapper").css({
      transform: "translate3d(0px, -" + utility.windowHeight * 1 + "px, 0px)",
  ...
  menuListTrigger: function () {
    ...
    //alert(utility.windowHeight +" : " +pos)
    $(".fullpage-wrapper").css({
      transform: "translate3d(0px, -" + utility.windowHeight * pos + "px, 0px)",
      transition: "none",
    });
    //utility.setall();
  },
  ...
  popupBoxOpen: function (ele) {
    ...
    if (ele.hasClass("sideScroll")) {
      ...
      PopupContent =
        '<div class="popCustomScroll">' + ele.attr("content") + "</div>";
  ...
  popupExit: function (arg) {
    ...
    $("#content_popup .popupScreenContainer closePopup").removeClass(
      "showNext"
    );
    $("#content_popup .popupScreenContainer > div.popupContent").html("");
    if (target == "#help_popup") {
  ...
  sectionload: function (target) {
    ...
    if (!previous == "") {
      ...
      $("mainBanner").css(
        "background-image",
        "url(common/images/bg/section" + splitNum + ".jpg)"
      );
    } else {
  ...
  CallFullPageFun: function (splitNum) {
    ...
    $(".courseTitleWrap .moduleTitle").text(
      controller.moduleTitle["mod_" + modNum]
    );
    ...
    setTimeout(function () {
      $("#Section" + splitNum + " > article").fullpage({
        ...
        afterLoad: function (anchorLink, index) {
          ...
          $(
            ".click_div_box, .click_div_box_sec16, .click_div_box_sec22, .click_div_box_sec27, .click_div_box_sec38"
          ).removeClass("expendDiv");
          ...
          $(
            ".section_8 .headingsIn img, .section_16 .headingsIn img, .section_22 .headingsIn img, .section_27 .headingsIn img, .section_38 .headingsIn img"
          ).removeClass("open");
          controller.setBookMarkData(index);
          scorm_obj.setSuspendedData("");
          if (
            index === $("#Section" + splitNum + " > article .section").length
          ) {
            setTimeout(function () {
          ...
          if (
            !controller.oneIsDone &&
            "sectionNum" != undefined &&
            sectionNum != "undefined" &&
            sectionNum != null &&
            sectionNum != "null" &&
            controller.fromBookmark
          ) {
        ...
        onLeave: function (
          ...
          if (index == 5) {
            utility.section6_timeOut = setTimeout(function () {
              $(
                ".section_6 .middle_section,.section_6 .middle_section2"
              ).addClass("move_left");
              $(
                ".section_6 .middle_section2 .left_box,.section_6 .middle_section2 .to"
              ).addClass("move_left1");
              $(".section_6 .middle_section2 .right_box").addClass(
                "move_right"
              );
            }, 3000);
          } else {
          ...
          if (index == 17) {
            ...
            clearTimeout(utility.section16_timeOut);
            // setTimeout(function(){
          ...
          if (index == 23) {
            ...
            utility.section22_timeOut = setTimeout(function () {
              ...
              $(
                ".section_22 .mid_four_container_heading, .section_22 .mid_four_container"
              ).addClass("active_on");
              // var showWrapIn = setTimeout(function(){
          ...
          if (index == 29) {
            ...
            utility.section27_timeOut = setTimeout(function () {
              ...
              $(".section_27 .mid_four_container,.forBox").removeClass(
                "active_on"
              );
              $(".section_27 .mid_four_container_wrapper").removeClass(
                "active_on"
              );
              $(".section_27 .mid_four_container").addClass("animated");
              $(
                ".section_27 .mid_four_container, .section_27 .forShadow"
              ).removeClass("hide_on");
            }, 4500);
          } else {
            ...
            // setTimeout(function(){
            $(
              ".section_27 .table_div,.section_27 .sec17_halfCircle,.section_27 .mentor_div,.section_27 .pot_div, .section_27 .bottom_strip"
            ).removeClass("active_on");
          ...
          if (index == 40) {
            ...
            utility.section37_timeOut = setTimeout(function () {
              $(".section_37 .rightboxWrap").addClass("moveRight");
              var showWrapIn = setTimeout(function () {
                $(".section_37 .clipboxWrapIn").addClass("showWrapIn");
              }, 500);
            }, 500);
  ...
  createRightTopSlider: function (slideN) {
    ...
    if (slideN >= 4 && slideN <= 5) {
      ...
      leftVal = -211;
      enblMn = 5;
    } else if (slideN >= 30 && slideN < 38) {
      leftVal = -280;
      enblMn = 6;
    } else if (slideN >= 38 && slideN < 42) {
      leftVal = -350;
      enblMn = 7;
    } else if (slideN >= 42) {
      leftVal = -410;
    ...
    $(".menuIconWrap")
      .removeAttr("id")
      .attr("id", "enableSVG" + enblMn);

    if (slideN > 42 || slideN < 4) {
      el.hide();
