...
function loadPage()
{
   ...
   var result = doLMSInitialize();
    ...
    if(!result || result === "false"){
       //model.isScorm = false;
       // model.userName = prompt("Please enter your name", "Name");
       // model.userID = prompt("Please enter your SCB ID", "SCB ID");
    }else{
        // model.isScorm = true;
        // model.userName = doLMSGetValue("cmi.core.student_name");
        // model.userID = doLMSGetValue("cmi.core.student_id");
   ...
   // var status = pipwerks.SCORM.data.get("cmi.core.lesson_status");
   var status = doLMSGetValue( "cmi.core.lesson_status" );

   if (status == "not attempted")
   {
	  // the student is now attempting the lesson
     // pipwerks.SCORM.data.set("cmi.core.lesson_status", "incomplete");
...
function computeTime()
{
   ...
   // pipwerks.SCORM.data.set("cmi.core.session_time", formattedTime );
   doLMSSetValue( "cmi.core.session_time", formattedTime );
}

function doBack()
{
   // pipwerks.SCORM.data.set("cmi.core.exit", "suspend" );
   // pipwerks.SCORM.data.set("cmi.core.lesson_status", "incomplete" );
...
function doContinue( status )
{
   ...
   // pipwerks.SCORM.data.set( "cmi.core.exit", "" );
   doLMSSetValue( "cmi.core.exit", "" );

   // var mode = pipwerks.SCORM.data.get( "cmi.core.lesson_mode" );
   var mode = doLMSGetValue( "cmi.core.lesson_mode" );

   if ( mode != "review"  &&  mode != "browse" )
   { 
      // pipwerks.SCORM.data.set( "cmi.core.lesson_status", status );
